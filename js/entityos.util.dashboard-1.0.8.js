...
entityos._util.factory.dashboard = function (param)
{
		...
		},
		{
			...
			code: function (param)
			{
				...
				if (_.has(dashboard, 'initialise.controller'))
				{
					...
					entityos._util.controller.invoke(dashboard.initialise.controller, param)
				}
				else
				{
					entityos._util.controller.invoke('util-dashboard-process', param);
				}
			}
		},
		{
			...
			code: function (param)
			{
				...
				else
				{
					...
					entityos.cloud.retrieve(dashboard.storage);
				}
			}
		},
		{
						...
						if (!dashboard.multiple)
						{
							...
							if (dashboard.styles != undefined)
							{
								...
								if (styleDo != undefined)
								{
									...
									{
										entityos._util.controller.invoke(styleDo, _styleDo, data)
									}
								}
							}
						}
